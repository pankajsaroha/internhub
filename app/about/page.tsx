  ...
  return (
    <main className="content-page">
      ...
      <section className="content-section">
        ...
        <p>
          We focus on bridging the gap between theoretical knowledge and real-world
          application by offering guided projects that simulate industry-style work.
        </p>
      </section>
      ...
      <section className="content-section">
        ...
        <ul>
          ...
          <li>Completely online and globally accessible</li>
          <li>Structured programs with clear tasks and outcomes</li>
        </ul>
      </section>
      ...
      <section className="content-section">
        ...
        <ul>
          ...
          <li>Not a job placement or recruitment service</li>
          <li>No salary, stipend, or job guarantee is offered</li>
        </ul>
      </section>
